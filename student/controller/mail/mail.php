...
if(isset($_GET['sid'])){
    ...
    $check = "SELECT * FROM student WHERE studentid = '$cid'";
...
$phone = $row['phone'];
$body = "<center>Hi <b>$name</b>, Your registration is complete & Your student ID is <b>$cid</b>.<br>
		...
		;
    $qry = "UPDATE student SET password = '$password' WHERE studentid = '$cid'";
	# execute
