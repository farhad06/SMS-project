...
//exam time
class Examtime extends Connect {
	function viewtab($tab,$test){
		try{
		$re = $this->conn->query("SELECT * FROM $tab WHERE testname ='$test'");
...
////Select Exam
class Examselect extends Connect {
	function viewtab($tab,$mod,$class){
		try{
		$re = $this->conn->query("SELECT * FROM $tab WHERE class='$class' AND mode='$mod' ");
...
class assignment extends Connect {
	function viewtab($tab,$class){
		try{
		$re = $this->conn->query("SELECT * FROM $tab WHERE class='$class'");
