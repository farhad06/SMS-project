...
<?php while($rows=$ru->fetch_assoc())
{
  ?>
    ...
    <tr>
    <td class="ce" onBlur="edit(this,'classname','<?php echo $rows['id']?>','class')"><?php echo $rows['classname'];?></td>
    <td class="ce" onBlur="edit(this,'coursename','<?php echo $rows['id']?>','class')"><?php echo $rows['coursename'];?></td>
...
<form method="post" id="regfrm" enctype="multipart/form-data">
  ...
  <table>
    <tr>
      <td>Class Name</td>
        <td><input type="text" name="classname" id="classname" minlength="2" required placeholder="BCA/1Sem"></td>
    </tr>
    <tr>
        <td>Select Under Course</td>
