...
<h2 align="center">Staff Search</h2><br />
   <center>
     <input type="text" name="search_text" id="search_text" required class="form-control" placeholder="Enter Staff Details" />
    </center>
  <br>  
...
<form method="post" id="regfrm" enctype="multipart/form-data">
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="salary" id="salary" required placeholder="0000" maxlength="8" minlength="4">
      </td>
    </tr>
    <tr>
      <td>
            ...
            $.ajax({
              ...
              success:function(response){
                if(response==1){
                  ...
                  $("#msg").addClass('alert alert-success').html("Staff Registration Successful.");
                  setTimeout(function(){
                    $("#msg").fadeOut(1000);
                  },4000);
                } else {
