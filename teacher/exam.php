...
<input type="hidden" name="date" id="date" value="<?php echo"$date" ;?>"> 
  <table>
    <tr>
      <td>Test Title</td>
        <td><input type="text" name="title" id="title" minlength="2" required placeholder="Test Name"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Time</td>
      <td>
        <input type="text" name="time" id='time' required placeholder="Time in Minutes">
      </td>
    </tr>
    <tr>
        <td>Test Mode</td>
