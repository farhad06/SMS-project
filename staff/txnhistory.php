...
<h2 align="center">Student Search</h2><br />
   <center>
     <input type="text" name="search_text" id="search_text" required class="form-control" placeholder="Enter Student Details" value="<?php echo"$date"; ?>">
    </center>
  <br>  
