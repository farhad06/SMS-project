...
<div class="w3l-table-info">
      ...
      <h3> <?php echo $rows['name']?> Profile</h3>
        <div class="col-md-6 agileits-w3layouts">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td>Photo</td>
                <td><a href="/SMS/admin/controller/<?php echo $rows['img'];?>"><img src="/SMS/admin/controller/<?php echo $rows['img'];?>" width="100" height="100"></a></td>
              </tr>
              <tr>
                <td>Employee Id</td>
              ...
              <tr>
                <td>Name</td>
                <td class="ce" onBlur="edit(this,'name','<?php echo $rows['id']?>','staff')"><?php echo $rows['name']?></td>
              </tr>
              ...
              <tr>
                <td>Date of birth</td>
                <td class="ce" onBlur="edit(this,'dob','<?php echo $rows['id']?>','staff')"><?php echo $rows['dob']?></td>
              </tr>
              ...
              <tr>
                ...
                <td class="ce" onBlur="edit(this,'qualification','<?php echo $rows['id']?>','staff')"><?php echo $rows['qualification']?></td>
              </tr>
              <tr>
                <td>Salary</td>
              ...
              <tr>
                <td>Mobile</td>
                <td class="ce" onBlur="edit(this,'phone','<?php echo $rows['id']?>','staff')"><?php echo $rows['phone']?></td>
              </tr>
              <tr>
                <td>Email</td>
                <td class="ce" onBlur="edit(this,'email','<?php echo $rows['id']?>','staff')"><?php echo $rows['email']?></td>
              </tr>
              <tr>
                <td>Address</td>
                <td class="ce" onBlur="edit(this,'address','<?php echo $rows['id']?>','staff')"><?php echo $rows['address']?></td>
              </tr>
        ...
        <form method="post" id="passfrm" enctype="multipart/form-data">
          <div class="vali-form vali-form1">
              <input type="hidden" name="studentid" id="studentid" value="<?php echo $_SESSION['staff']['id']?>">
      ...
      <div class="list-group list-group-alternate"> 
        ...
        <form method="post" id="photofrm" enctype="multipart/form-data">
          <input type="hidden" name="id" id="id" value="<?php echo $_SESSION['staff']['id']?>">
